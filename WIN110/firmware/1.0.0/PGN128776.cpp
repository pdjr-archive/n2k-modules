...
const int PGN128776::SpeedControl = 4;
const int PGN128776::SpeedControlType = 5;
const int PGN128776::AnchorDockingControl = 6;
const int PGN128776::PowerEnable = 7;
const int PGN128776::MechanicalLock = 8;
const int PGN128776::DeckAndAnchorWash = 9;
const int PGN128776::AnchorLight = 10;
const int PGN128776::CommandTimeout = 11;
const int PGN128776::WindlassControlEvents = 12;
...
void PGN128776::setProperty(int index, PGN128776_GenericField value) {
  switch (index) {
    ...
    case PGN128776::SpeedControl: this->setSpeedControl(value.F04); break;
    case PGN128776::SpeedControlType: this->setSpeedControlType(value.F05); break;
    case PGN128776::AnchorDockingControl: this->setAnchorDockingControl(value.F06); break;
    case PGN128776::PowerEnable: this->setPowerEnable(value.F07); break;
    case PGN128776::MechanicalLock: this->setMechanicalLock(value.F08); break;
    case PGN128776::DeckAndAnchorWash: this->setDeckAndAnchorWash(value.F09); break;
    case PGN128776::AnchorLight: setAnchorLight(value.F10); break;
    case PGN128776::CommandTimeout: setCommandTimeout(value.F11); break;
    case PGN128776::WindlassControlEvents: setWindlassControlEvents(value.F12); break;
    default: break;
  }
}
...
tN2kDD002 PGN128776::getAnchorDockingControl() {
  return this->properties[PGN128776::SID].value.F06;
}
...
void PGN128776::setSpeedControl(uint8_t value) {
  this->properties[PGN128776::SpeedControl].dirty = (this->properties[PGN128776::SpeedControl].value.F04 == value);
  this->properties[PGN128776::SpeedControl].value.F04 = value;
}
...
void PGN128776::setAnchorDockingControl(tN2kDD002 value) {
  this->properties[PGN128776::AnchorDockingControl].dirty = (this->properties[PGN128776::AnchorDockingControl].value.F06 == value);
  this->properties[PGN128776::AnchorDockingControl].value.F06 = value;
}

void PGN128776::setPowerEnable(tN2kDD002 value) {
  this->properties[PGN128776::PowerEnable].dirty = (this->properties[PGN128776::PowerEnable].value.F07 == value);
  this->properties[PGN128776::PowerEnable].value.F07 = value;
}

void PGN128776::setMechanicalLock(tN2kDD002 value) {
  this->properties[PGN128776::MechanicalLock].dirty = (this->properties[PGN128776::MechanicalLock].value.F08 == value);
  this->properties[PGN128776::MechanicalLock].value.F08 = value;
}

void PGN128776::setDeckAndAnchorWash(tN2kDD002 value) {
  this->properties[PGN128776::DeckAndAnchorWash].dirty = (this->properties[PGN128776::DeckAndAnchorWash].value.F09 == value);
  this->properties[PGN128776::DeckAndAnchorWash].value.F09 = value;
}

void PGN128776::setAnchorLight(tN2kDD002 value) {
  this->properties[PGN128776::AnchorLight].dirty = (this->properties[PGN128776::AnchorLight].value.F10 == value);
  this->properties[PGN128776::AnchorLight].value.F10 = value;
}

void PGN128776::setCommandTimeout(double value) {
  this->properties[PGN128776::CommandTimeout].dirty = (this->properties[PGN128776::CommandTimeout].value.F11 == value);
  this->properties[PGN128776::CommandTimeout].value.F11 = value;
}

void PGN128776::setWindlassControlEvents(tN2kDD478 value) {
  this->properties[PGN128776::WindlassControlEvents].dirty = (this->properties[PGN128776::WindlassControlEvents].value.F12 == value);
  this->properties[PGN128776::WindlassControlEvents].value.F12 = value;
}
